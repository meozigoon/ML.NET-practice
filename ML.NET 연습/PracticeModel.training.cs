...
namespace ML_NET_연습
{
    public partial class PracticeModel
    {
        public const string RetrainFilePath =  @"C:\Users\이동하\source\repos\ML.NET 연습\ML.NET 연습\yelp_labelled.txt";
